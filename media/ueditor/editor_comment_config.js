...
//        ,getMovieUrl:ServerURL+"getMovie"                   //视频数据获取地址
        ...
        ,toolbars:[["Unlink","Link","ClearDoc","GMap","Map","Emotion","HighlightCode","Bold","Italic","Underline"]]
        //当鼠标放在工具栏上时显示的tooltip提示
        ,labelMap:{"Unlink":'',"Link":'',"ClearDoc":'',"GMap":'',"Map":'',"Emotion":'',"HighlightCode":'',"Bold":'',"Italic":'',"Underline":''}
